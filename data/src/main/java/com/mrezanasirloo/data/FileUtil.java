...
import com.mrezanasirloo.data.loader.SortedCursor;
...
public final class FileUtil {
    ...
    @NonNull
    public static ArrayList<SongDomain> matchFilesWithMediaStore(@NonNull Context context, @Nullable List<File> files) {
